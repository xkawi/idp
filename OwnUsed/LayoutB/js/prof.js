$(document).ready(function(){
	...
	var fbAppt = new Firebase('https://idpdevelop.firebaseio.com/'+ CSOID + '/customer_appointments');
	var fbTime = new Firebase('https://idpdevelop.firebaseio.com/'+ CSOID + '/availabletime');
	var fbCust = new Firebase('https://idpdevelop.firebaseio.com/'+ CSOID + '/customers');
	var fbServ = new Firebase('https://idpdevelop.firebaseio.com/'+ CSOID + '/services');
	var fbBadges = new Firebase('https://idpdevelop.firebaseio.com/' + CSOID + '/badges');
	var fbCards = new Firebase('https://idpdevelop.firebaseio.com/' + CSOID + '/cards');
	var fbLead = new Firebase('https://idpdevelop.firebaseio.com/leaderboard');
	...
	$('body').on( 'click', '.cso', function () {
		...
		fbAppt = new Firebase('https://idpdevelop.firebaseio.com/'+ CSOID + '/customer_appointments');
		fbTime = new Firebase('https://idpdevelop.firebaseio.com/'+ CSOID + '/availabletime');
		fbCust = new Firebase('https://idpdevelop.firebaseio.com/'+ CSOID + '/customers');
		fbServ = new Firebase('https://idpdevelop.firebaseio.com/'+ CSOID + '/services');
		fbBadges = new Firebase('https://idpdevelop.firebaseio.com/' + CSOID + '/badges');
		fbCards = new Firebase('https://idpdevelop.firebaseio.com/' + CSOID + '/cards');
		loadGameStuffs();
		clearPanels();
	});
...
var UpdateCSOAvgScore = function(csoid, newavgtime){
	var ref = new Firebase('https://idpdevelop.firebaseio.com/leaderboard');
